...
IL_004a_1:
		...
		}
		{
			...
			String_t* L_25;
			L_25 = String_Concat_mF8B69BE42B5C5ABCAD3C176FBBE3010E0815D65D(L_20, _stringLiteral0CF1C526BD3872B6F7B223B157F80669490DCBCF, L_24, _stringLiteral9706EC31E2B043535F43A0B97CC1AA2377F4A865, NULL);
...
IL_0082_1:
		{
			...
			float L_35;
			L_35 = Random_Range_mF26F26EB446B76823B4815C91FA0907B484DF02B(L_32, L_34, NULL);
			V_4 = L_35;
			...
			SceneManager_MoveGameObjectToScene_m90813BE70C527D3C0FF06BA135AC3B88F851A668(L_38, L_42, NULL);
			...
			L_60 = Task_Delay_m49549664B58973EEEF1B479B21FB30D0DF3C7EFA(il2cpp_codegen_cast_double_to_int<int32_t>(((float)il2cpp_codegen_multiply((1000.0f), L_59))), NULL);
			NullCheck(L_60);
...
IL_0032_1:
			{
				...
				float L_15;
				L_15 = MMTween_Tween_m29815B7C14CCB14758B47D2D3389A61F44111697(L_8, (0.0f), (1.0f), L_10, L_12, L_14, NULL);
				V_3 = L_15;
				// if (RelativeValues)
